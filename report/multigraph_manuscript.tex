...
\begin{figure}[ht!]
  \centering
  \includegraphics[width=0.9\textwidth]{step-illustration}
...
\begin{figure}[ht!]
  % TODO
  \centering
  \includegraphics[width=0.5\textwidth]{triangle-slaving}
...
\begin{figure}[h!]
  ...
  \begin{subfigure}{0.75\textwidth}
    \centering
    \includegraphics[height=3in]{cpi-error}
  ...
  \begin{subfigure}{0.75\textwidth}
    \centering
    \includegraphics[height=3in]{self-error}
...
\begin{figure}[ht!]
  % TODO
  \centering
  \includegraphics[width=0.75\textwidth]{pca-2d-rho-kappa}
...
\begin{figure}[ht!]
  % TODO
  \centering
  \includegraphics[width=0.75\textwidth]{dmaps-2d-rho-kappa}
  \caption{Embedding of steady states in $\rho$ / $\kappa$ plane,
